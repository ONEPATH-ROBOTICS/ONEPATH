...
* **api_key** The API key for the agent. You can get your API key from the [ONEPATH Portal](https://one-path.io/).
...
The `agent_inputs` section defines the inputs for the agent. Inputs might include a camera, a LiDAR, a microphone, or governance information. ONEPATH implements the following input types:
