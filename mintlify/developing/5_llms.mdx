...
In addition to the response flowing to ONEPATH, which contains actions the robot should perform, there is an additional response you can use for debugging and to observe token usage ("usage").
...
1. **Upload Documents**: Visit [https://one-path.io/) to upload your documents and files to your knowledge base
