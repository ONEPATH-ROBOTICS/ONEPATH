...
First beta release for ONEPATH video processor. This release introduces major foundational features that enable developers and integrators to build advanced streaming and analytics solutions with ease.

### [v1.0.0-beta.1](https://github.com/ONEPATH-ROBOTICS/ONEPATH-video-processor/releases/tag/v1.0.0-beta.1)
...
The docker image is also available at [Docker Hub](https://hub.docker.com/layers/onepathai/onepath_video_processor/v1.0.0-beta.1).
