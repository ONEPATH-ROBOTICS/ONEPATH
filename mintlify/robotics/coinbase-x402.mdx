...
ONEPATH has a built-in x402 input and action modules. You can give your robot full economic autonomy by adding x402 input and action modules to its `.config` file.
