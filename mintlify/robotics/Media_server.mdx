...
ffmpeg -f avfoundation -video_size 1920x1080 -framerate 30 -i "0:0" \
  ...
  "rtmp://one-path.io:1935/<ONEPATH_API_KEY_ID>?api_key=<ONEPATH_API_KEY>"
```

**Note:** **ONEPATH_API_KEY_ID** refers to the first 16 digits of your API key, excluding the **om_prod_ prefix**. You can also find your corresponding **ONEPATH_API_KEY_ID** in our [portal](https://one-path.io/).

You can view your video stream at:

```bash
https://one-path.io/<ONEPATH_API_KEY_ID>?api_key=<ONEPATH_API_KEY>
```
