...
Using ONEPATH, the Unitree Go2 is able to autonomously explore spaces such as your home. There are several parts to this capability. To get started, launch ONEPATH:
...
ONEPATH uses the RPLIDAR to tell the core LLMs about nearby objects. This information flows as natural language to the core LLMs. The LIDAR data are also used in the action driver to check for viable paths before and during motions are executed.
