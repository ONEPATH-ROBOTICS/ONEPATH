...
ONEPATH is the core agentic software that enables autonomous decision-making and control for your robot. It runs as a dedicated Docker image, making deployment and integration straightforward.
...
This image contains all necessary dependencies and configuration for running ONEPATH.
