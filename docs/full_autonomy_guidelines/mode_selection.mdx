...
Once your Go2 is setup to run in full autonomy, you can get started with exploring different modes offered via ONEPATH and explore the functionalities.
...
Step 1: Configure your API key in ~/.bashrc file and start your machine in full autonomy mode.
Step 2: Login to your ONEPATH portal and head over to Machine Teleops on the left navigation bar.
...
These steps and exploration methods provide a structured approach to understanding and managing ONEPATH’s modes.
