...
For a full explanation of the smart contract implementation, see https://eips.ethereum.org/EIPS/eip-7777 and https://one-path.io/. The current governance rules are based on Asimov's Three Laws of Robotics.
