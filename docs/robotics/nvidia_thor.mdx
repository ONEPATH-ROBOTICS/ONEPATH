...
description: "Getting Started with ONEPATH on Nvidia Thor Dev Kit"
---
...
Then, install ONEPATH on the Nvidia Thor from its command line, following the [standard instructions](../developing/1_get-started.mdx).
...
You are now running ONEPATH on your Nvidia Thor. Explore its capabilities and refer to the [ONEPATH GitHub repository](https://github.com/ONEPATH-ROBOTICS/ONEPATH) for advanced settings and next steps.
