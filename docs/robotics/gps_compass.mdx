...
Once your Sense/FeatherWing is streaming data on the serial line, it can be fed into ONEPATH. See `src/inputs/plugins/serial_reader` for an example of how to do that.
