...
from onepath_speech import AudioOutputStream
...
class ElevenLabsTTSProvider:
    ...
    ----------
    url : str
        The URL endpoint for the TTS service. (Default is https://one-path.io/api/core/elevenlabs/tts)
    api_key : str
    ...
    def __init__(
        self,
        url: str = "https://one-path.io/api/core/elevenlabs/tts",
