...
class WebSim(Simulator):
    ...
    def __init__(self, config: SimulatorConfig):
        ...
        # Mount images directory for ONEPATH branding
        images_path = os.path.join(os.path.dirname(__file__), "../../../images")
        if os.path.exists(images_path):
            self.app.mount("/images", StaticFiles(directory=images_path), name="images")

        # Ensure the logo exists in images directory
        logo_path = os.path.join(os.path.dirname(__file__), "../../../images/Robot-1.jpeg")
                            ...
                            return (
                                <div className="min-h-screen p-4 pb-16">
                                    ...
                                    <div className="footer">
                                        <img
                                            src="/images/Robot-1.jpeg"
                                            alt="ONEPATH Logo"
                                            className="footer-logo"
                                        />
                                        <div className="footer-links">
                                            <a
                                                href="https://github.com/ONEPATH-ROBOTICS/ONEPATH"
                                                target="_blank"
