...
def start(
    ...
    """
    Start the ONEPATH agent with a specific configuration.
    ...
    try:
        ...
        if "modes" in raw_config and "default_mode" in raw_config:
            ...
            logging.info(f"Starting ONEPATH with mode-aware configuration: {config_name}")
            ...
            logging.info(f"Starting ONEPATH with standard configuration: {config_name}")
