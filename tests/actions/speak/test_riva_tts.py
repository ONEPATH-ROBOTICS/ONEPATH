...
sys.modules["onepath_speech"] = MagicMock()
sys.modules["onepath_utils"] = MagicMock()
sys.modules["onepath_utils.ws"] = MagicMock()
sys.modules["onepath_speech.AudioInputStream"] = MagicMock()
