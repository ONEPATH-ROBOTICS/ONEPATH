...
mock_onepath_speech = MagicMock()
mock_onepath_speech.AudioOutputStream = MagicMock()
sys.modules["onepath_speech"] = mock_onepath_speech
...
def test_configure_no_restart_when_same_parameters():
    ...
    url = "https://one-path.io/api/core/elevenlabs/tts"
    api_key = "same_key"
    ...
    mock_onepath_speech.AudioOutputStream.return_value = mock_audio_stream
